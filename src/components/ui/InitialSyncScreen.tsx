        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <div className="flex justify-between text-sm font-medium text-gray-700 dark:text-gray-300">
              <span><FormattedMessage id="sync.initial.syncing" defaultMessage="Syncing {step}..." values={{ step: currentStep }} /></span>
          ...
          {progress?.status === 'error' && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                {progress.error || intl.formatMessage({ id: 'sync.initial.error', defaultMessage: 'Sync failed. Please try again later.' })}
              </AlertDescription>
            </Alert>
          )}

          <p className="text-xs text-muted-foreground text-center pt-2">
            <FormattedMessage id="sync.initial.hint" defaultMessage="Please keep the application open during this process." />
          </p>
        </CardContent>
      </AnimatedCard>
    </div>
